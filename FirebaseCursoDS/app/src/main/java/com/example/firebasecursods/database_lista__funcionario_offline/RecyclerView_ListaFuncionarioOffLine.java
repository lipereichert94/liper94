...
public class RecyclerView_ListaFuncionarioOffLine extends RecyclerView.Adapter<RecyclerView_ListaFuncionarioOffLine.ViewHolder>{



    private Context context;
    private List<FuncionarioOffLine> funcionarios;
    private ClickFuncionario clickFuncionario;

    public RecyclerView_ListaFuncionarioOffLine(Context context, List<FuncionarioOffLine> funcionarios, ClickFuncionario clickFuncionario){
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        final FuncionarioOffLine funcionario = funcionarios.get(position);
    ...
    public interface ClickFuncionario{
        ...
        void click_Funcionario(FuncionarioOffLine funcionario);
